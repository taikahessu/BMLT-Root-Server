...
/** \file	server_admin_strings.inc.php
	...
	$comdef_server_admin_strings = array (  'account_disclosure'                                    =>  'Oma tili',
	                                        'account_name_label'                                    =>  'Oman tilin nimi:',
	                                        'account_login_label'                                   =>  'Käyttäjätunnus:',
	                                        'account_type_label'                                    =>  'Käyttäjätaso:',
	                                        'account_type_1'                                        =>  'Pääkäyttäjä',
	                                        'account_type_2'                                        =>  'Palveluelimen ylläpitäjä',
											'ServerMapsURL'                                         =>  'https://maps.googleapis.com/maps/api/geocode/xml?address=##SEARCH_STRING##&sensor=false',
	                                        'account_type_4'                                        =>  'Joku, jolla ei kuuluisi olla pääsyä sovellukseen!',
	                                        'account_type_5'                                        =>  'Palveluelimen tarkastaja',
	                                        'change_password_label'                                 =>  'Vaihda salasanani:',
	                                        'change_password_default_text'                          =>  'Jätä tyhjäksi mikäli et halua vaihtaa salasanaa.',
	                                        'account_email_label'                                   =>  'Sähköpostiosoite:',
	                                        'email_address_default_text'                            =>  'Anna sähköpostiosoite',
	                                        'account_description_label'                             =>  'Käyttäjän kuvaus:',
	                                        'account_description_default_text'                      =>  'Anna kuvaus',
	                                        'account_change_button_text'                            =>  'Vaihda tilin asetuksia',
	                                        'account_change_fader_success_text'                     =>  'Tilin asetukset muutettu onnistuneesti',
	                                        'account_change_fader_failure_text'                     =>  'Tilin asetuksia ei muutettu',
	                                        'meeting_editor_disclosure'                             =>  'Kokouksen muokkaus',
	                                        'meeting_editor_already_editing_confirm'                =>  'Olet muokkaamassa toista kokousta. Hylätäänkö kaikki muutokset siihen kokoukseen?',
	                                        'meeting_change_fader_success_text'                     =>  'Kokouksen tiedot muutettu onnistuneesti',
	                                        'meeting_change_fader_failure_text'                     =>  'Kokouksen tietoja ei muutettu',
	                                        'meeting_change_fader_success_delete_text'              =>  'Kokous poistettu onnistuneesti',
	                                        'meeting_change_fader_fail_delete_text'                 =>  'Kokousta ei poistettu',
	                                        'meeting_change_fader_success_add_text'                 =>  'Uusi kokous lisättiin onnistuneesti',
	                                        'meeting_change_fader_fail_add_text'                    =>  'Uutta kokousta ei lisätty',
	                                        'meeting_text_input_label'                              =>  'Hae tekstihaulla:',
	                                        'access_service_body_label'                             =>  'Minulla on pääsy:',
	                                        'meeting_text_input_default_text'                       =>  'Anna hakuarvo',
	                                        'meeting_text_location_label'                           =>  'Tämä on Sijainti tai Postinumero',
	                                        'meeting_search_weekdays_label'                         =>  'Hae valituilla viikonpäivillä:',
	                                        'meeting_search_weekdays_names'                         =>  array ( 'Kaikki', 'Sunnuntai', 'Maanantai', 'Tiistai', 'Keskiviikko', 'Torstai', 'Perjantai', 'Lauantai' ),
	                                        'meeting_search_service_bodies_label'                   =>  'Hae valituilla palveluelimillä:',
	                                        'meeting_search_start_time_label'                       =>  'Hae kokouksen alkamisajalla:',
	                                        'meeting_search_start_time_all_label'                   =>  'Mikä tahansa aika',
	                                        'meeting_search_start_time_morn_label'                  =>  'Aamu',
	                                        'meeting_search_start_time_aft_label'                   =>  'Iltapäivä',
	                                        'meeting_search_start_time_eve_label'                   =>  'Ilta',
	                                        'meeting_search_no_results_text'                        =>  'Kokouksia ei löytynyt',
	                                        'meeting_editor_tab_specifier_text'                     =>  'Etsi kokouksia',
	                                        'meeting_editor_tab_editor_text'                        =>  'Muokkaa kokouksia',
	                                        'meeting_editor_create_new_text'                        =>  'Luo uusi kokous',
	                                        'meeting_editor_location_map_link'                      =>  'Sijaintikartta',
	                                        'meeting_editor_screen_match_map_button'                =>  'Aseta kartta osoitteeseen',
	                                        'meeting_editor_screen_match_ll_button'                 =>  'Anna Leveys ja Pituus arvot osoitteelle',
	                                        'meeting_editor_screen_default_text_prompt'             =>  'Syötä teksti tai numero',
	                                        'meeting_is_published'                                  =>  'Kokous on julkaistu',
	                                        'meeting_editor_screen_meeting_name_label'              =>  'Kokouksen nimi:',
	                                        'meeting_editor_screen_meeting_name_prompt'             =>  'Anna kokouksen nimi',
	                                        'meeting_editor_screen_meeting_weekday_label'           =>  'Viikonpäivä:',
	                                        'meeting_editor_screen_meeting_start_label'             =>  'Kokouksen alkamisaika:',
	                                        'meeting_editor_screen_meeting_am_label'                =>  'AM',
	                                        'meeting_editor_screen_meeting_pm_label'                =>  'PM',
	                                        'meeting_editor_screen_meeting_noon_label'              =>  'Keskipäivä',
	                                        'meeting_editor_screen_meeting_midnight_label'          =>  'Keskiyö',
	                                        'meeting_editor_screen_meeting_duration_label'          =>  'Kesto:',
	                                        'meeting_editor_screen_meeting_oe_label'                =>  'Rajaton kesto',
	                                        'meeting_editor_screen_meeting_cc_label'                =>  'Maailmanpalvelun koodi:',
	                                        'meeting_editor_screen_meeting_cc_prompt'               =>  'Anna maailmanpalvelun koodi',
	                                        'meeting_editor_screen_meeting_contact_label'           =>  'Kokouksen / ryhmän sähköposti:',
	                                        'meeting_editor_screen_meeting_contact_prompt'          =>  'Anna sähköposti, jolla voi ottaa yhteyttä juuri tähän kokoukseen',
	                                        'meeting_editor_screen_meeting_sb_label'                =>  'Palveluelin:',
	                                        'meeting_editor_screen_meeting_sb_default_value'        =>  'Palveluelintä ei valittu',
	                                        'meeting_editor_screen_meeting_longitude_label'         =>  'Pituusaste (Longitude):',
	                                        'meeting_editor_screen_meeting_longitude_prompt'        =>  'Anna pituusaste',
	                                        'meeting_editor_screen_meeting_latitude_label'          =>  'Leveysaste (Latitude):',
	                                        'meeting_editor_screen_meeting_latitude_prompt'         =>  'Anna leveysaste',
	                                        'meeting_editor_screen_meeting_location_label'          =>  'Sijainti:',
	                                        'meeting_editor_screen_meeting_location_prompt'         =>  'Anna sijainni nimi (kuten rakennuksen nimi)',
	                                        'meeting_editor_screen_meeting_info_label'              =>  'Lisätiedot:',
	                                        'meeting_editor_screen_meeting_info_prompt'             =>  'Anna lisätietoa sijainnista',
	                                        'meeting_editor_screen_meeting_street_label'            =>  'Katuosoite:',
	                                        'meeting_editor_screen_meeting_street_prompt'           =>  'Anna katuosoite',
	                                        'meeting_editor_screen_meeting_neighborhood_label'      =>  'Lähiseutu / alue:',
	                                        'meeting_editor_screen_meeting_neighborhood_prompt'     =>  'Anna lähiseutu / alue (ei kaupunginosa)',
	                                        'meeting_editor_screen_meeting_borough_label'           =>  'Kaupunginosa:',
	                                        'meeting_editor_screen_meeting_borough_prompt'          =>  'Anna kaupunginosa (ei lähiseutu / alue)',
	                                        'meeting_editor_screen_meeting_city_label'              =>  'Kaupunki:',
